...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        getExchangeHistorical("2022-02-02", 2000.0);
    ...
    public static void getExchangeHistorical(String purchaseDate, double amount){
        ...
        if (historicalValue < latestValue){
            System.out.println("This is a goo moment to sell USD and buy PLN, 1.0 USD is equal to: " + latestValue);
            ...
            System.out.println("You will earn: " + ((historicalValue*amount) - (latestValue*amount)) +"PLN");
        }
